...
public interface Config {
	...
	/**
	 * Return the array property value with the given key, or {@code defaultValue}
	 * if the key doesn't exist.
	 *
	 * @param key
	 *            the property name
	...
	/**
	 * Return the Date property value with the given name, or {@code defaultValue}
	 * if the name doesn't exist. Will try to parse the date with Locale.US and
	 * formats as follows: yyyy-MM-dd HH:mm:ss.SSS, yyyy-MM-dd HH:mm:ss and
	 * yyyy-MM-dd
	 *
	 * @param key
	 *            the property name
	...
	/**
	 * Return the Date property value with the given name, or {@code defaultValue}
	 * if the name doesn't exist. Will parse the date with the format specified and
	 * Locale.US
	 *
	 * @param key
	 *            the property name
	 * @param format
	 *            the date format, see {@link java.text.SimpleDateFormat} for more
	 *            information
	 * @param defaultValue
	 *            the default value when name is not found or any error occurred
	 * @return the property value
	...
	/**
	 * Return the Enum property value with the given key, or {@code defaultValue} if
	 * the key doesn't exist.
	 *
	 * @param key
	 *            the property name
	 ...
	 * {@code
	 * defaultValue} if the name doesn't exist. Please note the format should comply
	 * with the follow example (case insensitive). Examples:
	 * 
	 * <pre>
