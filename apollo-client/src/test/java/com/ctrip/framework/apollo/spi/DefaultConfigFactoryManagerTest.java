...
public class DefaultConfigFactoryManagerTest {
	...
	public void testGetFactoryFromRegistry() throws Exception {
		ConfigFactory result = defaultConfigFactoryManager.getFactory(MockConfigRegistry.NAMESPACE_REGISTERED);
	...
	public void testGetFactoryFromNamespaceMultipleTimes() throws Exception {
		...
		assertThat("Get config factory with the same namespace multiple times should returnt the same instance",
