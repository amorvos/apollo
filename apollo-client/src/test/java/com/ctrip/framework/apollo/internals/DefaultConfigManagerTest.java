...
public class DefaultConfigManagerTest {
	...
	public void testGetConfigMultipleTimesWithSameNamespace() throws Exception {
		...
		assertThat("Get config multiple times with the same namespace should return the same config instance", config,
	...
	public void testGetConfigFileMultipleTimesWithSameNamespace() throws Exception {
		...
		assertThat("Get config file multiple times with the same namespace should return the same config file instance",
