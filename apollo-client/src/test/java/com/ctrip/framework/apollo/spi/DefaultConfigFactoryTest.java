...
public class DefaultConfigFactoryTest {
	...
	public void testCreateLocalConfigRepositoryInLocalDev() throws Exception {
		...
		LocalFileConfigRepository localFileConfigRepository = defaultConfigFactory
	...
	public void testCreateConfigFile() throws Exception {
		...
		ConfigFile propertyConfigFile = defaultConfigFactory.createConfigFile(someNamespace,
		...
		assertThat("Should create JsonConfigFile for json format", jsonConfigFile,
		...
		assertThat("Should create YamlConfigFile for yaml format", yamlConfigFile,
