...
public class AppNamespaceController {
	...
	@RequestMapping(value = "/app-namespaces/{publicNamespaceName}/namespaces", method = RequestMethod.GET)
	...
	@RequestMapping(value = "/app-namespaces/{publicNamespaceName}/associated-namespaces/count", method = RequestMethod.GET)
