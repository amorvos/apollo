 ...
 * </pre>
 *
 * To make <code>@ConditionalOnProperty</code> work properly,
 * <code>apollo.bootstrap.enabled</code> should be set to true and
 * <code>redis.cache.enabled</code> should also be set to true.
 *
