...
public interface ConfigService extends ReleaseMessageListener {
	 ...
	 *            the client ip
	 * @param configAppId
	 *            the requested config's app id
	 * @param configClusterName
	 *            the requested config's cluster name
	 * @param configNamespace
	 *            the requested config's namespace name
	 * @param dataCenter
	 *            the client data center
	 * @param clientMessages
	 *            the messages received in client side
	 * @return the Release
	 */
