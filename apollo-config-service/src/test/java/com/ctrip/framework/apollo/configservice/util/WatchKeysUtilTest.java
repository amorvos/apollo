...
public class WatchKeysUtilTest {
	...
	public void testAssembleAllWatchKeysWithMultipleNamespaces() throws Exception {
		Multimap<String, String> watchKeysMap = watchKeysUtil.assembleAllWatchKeys(someAppId, someCluster,
	...
	public void testAssembleWatchKeysForNoAppIdPlaceHolderAndPublicNamespace() throws Exception {
		Multimap<String, String> watchKeysMap = watchKeysUtil.assembleAllWatchKeys(ConfigConsts.NO_APPID_PLACEHOLDER,
				someCluster, Sets.newHashSet(someNamespace, somePublicNamespace), someDC);
