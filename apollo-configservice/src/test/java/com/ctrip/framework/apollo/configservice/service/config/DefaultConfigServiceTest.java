...
public class DefaultConfigServiceTest {
	...
	public void setUp() throws Exception {
		...
		when(grayReleaseRulesHolder.findReleaseIdFromGrayReleaseRule(anyString(), anyString(), anyString(), anyString(),
	...
	public void testLoadConfig() throws Exception {
		...
		Release release = configService.loadConfig(someClientAppId, someClientIp, someConfigAppId, someClusterName,
	...
	public void testLoadConfigWithGrayRelease() throws Exception {
		...
		when(grayReleaseRulesHolder.findReleaseIdFromGrayReleaseRule(someClientAppId, someClientIp, someConfigAppId,
				someClusterName, defaultNamespaceName)).thenReturn(grayReleaseId);
	...
	public void testLoadConfigWithDefaultClusterWithDataCenterRelease() throws Exception {
		...
		Release release = configService.loadConfig(someClientAppId, someClientIp, someConfigAppId, defaultClusterName,
				defaultNamespaceName, someDataCenter, someNotificationMessages);
