...
public class NamespaceController {
	...
	/**
	 * env -> cluster -> cluster has not published namespace? Example: dev ->
	 * default -> true (default cluster has not published namespace) customCluster
	 * -> false (customCluster cluster's all namespaces had published)
	 */
