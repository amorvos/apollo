(function () {
    ...
    var n = function (e, t, n) {
        ...
        if (!s) {
            ...
            if (typeof s == "function") {
                var o = {}, u = {id: r, uri: "", exports: o, packaged: !0},
                    a = function (e, t) {
                        return n(r, e, t)
                    }, f = s(a, o, u);
    ...
    var i = Function.prototype.call, s = Array.prototype, o = Object.prototype,
        u = s.slice, a = i.bind(o.toString), f = i.bind(o.hasOwnProperty), l, c,
        h, p, d;
    ...
    if ([1, 2].splice(0).length != 2) if (!function () {
        ...
        if (e === n) s && this.push.apply(this, i); else {
            var o = Math.min(t, n - e), a = e + o, f = a + s - o, l = n - a,
                c = n - o;
    ...
    Array.prototype.forEach || (Array.prototype.forEach = function (t) {
        ...
        var n = F(this),
            r = g && a(this) == "[object String]" ? this.split("") : n,
            i = r.length >>> 0, s = [], o, u = arguments[1];
        if (a(t) != "[object Function]") throw new TypeError(t + " is not a function");
    ...
    "use strict";
    var r = e("../lib/event"), i = e("../lib/useragent"), s = e("../lib/dom"),
        o = e("../lib/lang"), u = e("../lib/keys"), a = u.KEY_MODS,
        f = i.isChrome < 18, l = i.isIE, c = function (e, t) {
            function x(e) {
                if (m) return;
                m = !0;
    ...
    "use strict";
    var r = e("../lib/event"), i = e("../lib/useragent"), s = e("../lib/dom"),
        o = e("../lib/lang"), u = i.isChrome < 18, a = i.isIE,
        f = e("./textinput_ios").TextInput, l = function (e, t) {
            function w(e) {
                if (p) return;
                p = !0;
                if (T) var t = 0,
                    r = e ? 0 : n.value.length - 1; else var t = e ? 2 : 1, r = 2;
                try {
    ...
    function l(e, t) {
        ...
        return n < 0 ? {cursor: e.start, anchor: e.end} : {
            cursor: e.end,
            anchor: e.start
        }
    }

    var r = e("../lib/dom"), i = e("../lib/event"), s = e("../lib/useragent"),
        o = 0, u = 250;
    (function () {
        this.onMouseDown = function (e) {
            ...
            var t = e.getDocumentPosition(), n = this.editor, r = n.session,
            ...
            var n = this.$lastScroll, r = e.domEvent.timeStamp, i = r - n.t,
                s = e.wheelX / i, o = e.wheelY / i;
    ...
    function u(e) {
        function l() {
            ...
            if (e.$tooltipFollowsMouse) h(u); else {
                var p = u.domEvent.target, d = p.getBoundingClientRect(),
    ...
    var r = e("../lib/dom"), i = e("../lib/oop"), s = e("../lib/event"),
        o = e("../tooltip").Tooltip;
    ...
    function f(e) {
        function T(e, n) {
            var r = Date.now(), i = !n || e.row != n.row,
        ...
        function N(e, n) {
            var r = Date.now(), i = t.renderer.layerConfig.lineHeight,
                s = t.renderer.layerConfig.characterWidth,
                u = t.renderer.scroller.getBoundingClientRect(), a = {
            ...
            var h = e.row != c.row, v = e.column != c.column,
                m = !n || e.row != n.row;
    ...
    var r = e("./lib/lang"), i = e("./lib/oop"), s = e("./lib/net"),
    ...
    var r = e("../lib/event"), i = e("../lib/useragent"),
        ...
        a = e("./dragdrop_handler").DragdropHandler, f = e("../config"),
        l = function (e) {
            var t = this;
            ...
            r.addListener(f, "mousedown", this.onMouseEvent.bind(this, "guttermousedown")), r.addListener(f, "click", this.onMouseEvent.bind(this, "gutterclick")), r.addListener(f, "dblclick", this.onMouseEvent.bind(this, "gutterdblclick")), r.addListener(f, "mousemove", this.onMouseEvent.bind(this, "guttermousemove")), r.addListener(u, "mousedown", n), r.addListener(f, "mousedown", n), i.isIE && e.renderer.scrollBarV && (r.addListener(e.renderer.scrollBarV.element, "mousedown", n), r.addListener(e.renderer.scrollBarH.element, "mousedown", n)), e.on("mousemove", function (n) {
                ...
                var r = e.renderer.screenToTextCoordinates(n.x, n.y),
                    i = e.session.selection.getRange(), s = e.renderer;
    ...
    function r(e) {
        e.on("click", function (t) {
            var n = t.getDocumentPosition(), r = e.session,
    ...
    function F(e, t, n, r) {
        var i = s ? d : p, c = null, h = null, v = null, m = 0, g = null,
            y = null, b = -1, w = null, E = null, T = [];
    ...
    var r = ["\u0621", "\u0641"], i = ["\u063a", "\u064a"], s = 0, o = 0,
        u = !1, a = !1, f = !1, l = !1, c = !1, h = !1,
        ...
        v = 0, m = 1, g = 0, y = 1, b = 2, w = 3, E = 4, S = 5, x = 6, T = 7,
        N = 8, C = 9, k = 10, L = 11, A = 12, O = 13, M = 14, _ = 15, D = 16,
        P = 17, H = 18,
    ...
    t.L = g, t.R = y, t.EN = b, t.ON_R = 3, t.AN = 4, t.R_H = 5, t.B = 6, t.DOT = "\u00b7", t.doBidiReorder = function (e, n, r) {
        ...
        var i = e.split(""), o = new Array(i.length), u = new Array(i.length),
            a = [];
    ...
    (function () {
        this.isBidiRow = function (e, t, n) {
            ...
            var e = [], t = this.isLastRow ? this.EOF : this.EOL,
            ...
            var n = this.bidiMap, i = n.bidiLevels, s,
                o = this.wrapIndent * this.charWidths[r.L], u = [],
                a = Math.min(e, t) - this.wrapIndent,
                f = Math.max(e, t) - this.wrapIndent, l = !1, c = !1, h = 0;
            ...
            var t = 0, e = Math.max(e, 0), n = 0, i = 0,
                s = this.bidiMap.bidiLevels, o = this.charWidths[s[i]];
    ...
    (function () {
        this.isEqual = function (e) {
            ...
            if (n == 0) return this;
            if (n == -1) var r = {row: e, column: t}; else var s = {
                row: e,
                column: t
            };
    ...
    var r = e("./lib/oop"), i = e("./lib/lang"),
        s = e("./lib/event_emitter").EventEmitter, o = e("./range").Range,
        u = function (e) {
    ...
    (function () {
        r.implement(this, s), this.isEmpty = function () {
            ...
            var t = this.getSelectionAnchor(), n = this.getSelectionLead(),
                r = this.isBackwards();
            ...
            var n = typeof e == "number" ? e : this.lead.row, r,
            ...
            var e = this.lead.row, t = this.lead.column,
                n = this.doc.getLine(e), r = n.substring(t), i;
            ...
            var e = this.lead.row, t = this.lead.column,
                n = this.doc.getLine(e), r = n.substring(t),
    ...
    var r = e("./config"), i = 2e3, s = function (e) {
        ...
        for (var t in this.states) {
            var n = this.states[t], r = [], i = 0,
                s = this.matchMappings[t] = {defaultToken: "text"}, o = "g",
                u = [];
    ...
    var r = e("../../lib/oop"), i = e("../behaviour").Behaviour,
        s = e("../../token_iterator").TokenIterator, o = e("../../lib/lang"),
        u = ["text", "paren.rparen", "punctuation.operator"],
        a = ["text", "paren.rparen", "punctuation.operator", "comment"], f,
        l = {}, c = {'"': '"', "'": "'"}, h = function (e) {
            var t = -1;
            ...
            this.add("braces", "insertion", function (t, n, r, i, s) {
                ...
                if (i.length == 1 && s[i]) {
                    ...
                    if (!a) {
                        var f = n.getCursorPosition(), l = r.doc.getLine(f.row),
                        ...
                        var y = m && /string|escape/.test(m.type),
                            b = !g || /string|escape/.test(g.type), w;
    ...
    var r = e("../tokenizer").Tokenizer,
        ...
        u = e("../lib/lang"), a = e("../token_iterator").TokenIterator,
    ...
    (function () {
        this.$defaultBehaviour = new s, this.tokenRe = new RegExp("^[" + o.packages.L + o.packages.Mn + o.packages.Mc + o.packages.Nd + o.packages.Pc + "\\$_]+", "g"), this.nonTokenRe = new RegExp("^(?:[^" + o.packages.L + o.packages.Mn + o.packages.Mc + o.packages.Nd + o.packages.Pc + "\\$_]|\\s])+", "g"), this.getTokenizer = function () {
            ...
            var i = t.doc, s = !0, o = !0, a = Infinity, f = t.getTabSize(),
                l = !1;
                ...
                var c = this.blockComment.start, h = this.blockComment.end,
                    ...
                    v = function (e, t) {
                        ...
                        if (!s || /\S/.test(e)) i.insertInLine({
                            row: t,
                            column: e.length
                        }, h), i.insertInLine({row: t, column: a}, c)
                    }, m = function (e, t) {
                        var n;
            ...
            var s = new a(t, r.row, r.column), o = s.getCurrentToken(),
                u = t.selection, l = t.selection.toOrientedRange(), c, h;
    ...
    (function () {
        ...
        function t(t, n, r) {
            var i = t.action == "insert",
                ...
                o = (i ? 1 : -1) * (t.end.column - t.start.column), u = t.start,
                a = i ? u : t.end;
            return e(n, u, r) ? {
                row: n.row,
                column: n.column
    ...
    "use strict";
    var r = e("./lib/oop"), i = e("./apply_delta").applyDelta,
        s = e("./lib/event_emitter").EventEmitter, o = e("./range").Range,
    ...
    (function () {
        r.implement(this, s), this.setValue = function (e) {
            ...
            var n = t == this.getLength() - 1 && e > 0,
                r = t < this.getLength() - 1, i = n ? e - 1 : e,
                s = n ? this.getLine(i).length : 0, u = r ? t + 1 : t,
                a = r ? 0 : this.getLine(u).length, f = new o(i, s, u, a),
            ...
            var n = e.lines, r = n.length, i = e.start.row, s = e.start.column,
                o = 0, u = 0;
            do {
                o = u, u += t - 1;
                var a = n.slice(o, u);
    ...
    "use strict";
    var r = e("./lib/lang"), i = e("./lib/oop"), s = e("./range").Range,
        o = function (e, t, n) {
    ...
    (function () {
        this.shiftRow = function (e) {
            ...
            var r = n.fold, s = this.folds, o = this.foldData, u = s.indexOf(r),
                a = s[u - 1];
    ...
    (function () {
        this.comparePoints = i, this.pointIndex = function (e, t, n) {
            ...
            if (e.action == "insert") var t = e.start,
                n = e.end; else var n = e.start, t = e.end;
            var r = t.row, i = n.row, s = i - r, o = -t.column + n.column,
                u = this.ranges;
    ...
    var r = e("../range").Range, i = e("../range_list").RangeList,
        s = e("../lib/oop"), o = t.Fold = function (e, t) {
    ...
    function u() {
        this.getFoldAt = function (e, t, n) {
            ...
            var u = o.start.row, a = o.start.column, f = o.end.row,
                l = o.end.column;
            if (u < f || u == f && a <= l - 2) {
            ...
            var t = e.foldLine, n = t.start.row, r = t.end.row,
                i = this.$foldData, s = t.folds;
    ...
    var r = e("../range").Range, i = e("./fold_line").FoldLine,
        s = e("./fold").Fold, o = e("../token_iterator").TokenIterator;
    t.Folding = u
    ...
    function s() {
        this.findMatchingBracket = function (e, t) {
            ...
            var i = this.$brackets[e], s = 1, o = new r(this, t.row, t.column),
                u = o.getCurrentToken();
            u || (u = o.stepForward());
            if (!u) return;
    ...
    "use strict";
    var r = e("./lib/oop"), i = e("./lib/lang"),
        s = e("./bidihandler").BidiHandler, o = e("./config"),
        u = e("./lib/event_emitter").EventEmitter,
        a = e("./selection").Selection, f = e("./mode/text").Mode,
        l = e("./range").Range, c = e("./document").Document,
    ...
    d.$uid = 0, function () {
        ...
        r.implement(this, u), this.setDocument = function (e) {
            ...
            if (this.$modified || e) {
                ...
                var t = this.doc.getAllLines(), n = this.$rowLengthCache, r = 0,
                    i = 0, s = this.$foldData[i],
            ...
            var r = this.getTextRange(e), i = this.getFoldsInRange(e),
                s = l.fromPoints(t, t);
            if (!n) {
                this.remove(e);
            ...
            if (i.length) {
                var a = e.start, f = s.start, o = f.row - a.row,
                    u = f.column - a.column;
            ...
            var t = e.collapseRows(), n = new l(0, 0, 0, 0),
                r = this.getTabSize();
            ...
            var t = this.$useWrapMode, n = e.action, r = e.start, i = e.end,
                s = r.row, o = i.row, u = o - s, a = null;
            this.$updating = !0;
            if (u != 0) if (n === "remove") {
            ...
            var r = this.doc.getAllLines(), i = this.getTabSize(),
                o = this.$wrapData, u = this.$wrapLimit, a, f, l = e;
        ...
        this.$computeWrapSplits = function (e, r, i) {
            ...
            var o = [], u = e.length, f = 0, l = 0, h = this.$wrapAsCode,
            ...
            var r, i = 0, s = 0, o, u = 0, a = 0, f = this.$screenRowCache,
                l = this.$getRowCacheIndex(f, e), c = f.length;
            if (c && l >= 0) var u = f[l], i = this.$docRowCache[l],
                h = e > f[c - 1]; else var h = !c;
            var p = this.getLength() - 1, d = this.getNextFoldLine(i),
            ...
            var o, u = 0, a = this.$docRowCache,
                f = this.$getRowCacheIndex(a, e), l = a.length;
            if (l && f >= 0) var u = a[f], r = this.$screenRowCache[f],
            ...
            if (!this.$useWrapMode) {
                ...
                var i = this.$wrapData.length, s = 0, r = 0,
                    t = this.$foldData[r++], o = t ? t.start.row : Infinity;
                while (s < i) {
    ...
    (function () {
        this.set = function (e) {
            ...
            if (n) {
                var w = n.start.column, E = n.start.column, g = 0,
                    h = o.length - 1;
            ...
            if (!n) return !1;
            var r = t.backwards == 1, i = t.skipCurrent != 0, s = t.range,
                o = t.start;
    ...
    var r = e("./lib/oop"), i = e("./lib/dom"), s = e("./lib/lang"),
        o = e("./lib/useragent"), u = e("./keyboard/textinput").TextInput,
        a = e("./mouse/mouse_handler").MouseHandler,
        f = e("./mouse/fold_handler").FoldHandler,
        l = e("./keyboard/keybinding").KeyBinding,
        c = e("./edit_session").EditSession, h = e("./search").Search,
        p = e("./range").Range, d = e("./lib/event_emitter").EventEmitter,
        v = e("./commands/command_manager").CommandManager,
        m = e("./commands/default_commands").commands, g = e("./config"),
        y = e("./token_iterator").TokenIterator, b = function (e, t) {
    ...
    b.$uid = 0, function () {
        r.implement(this, d), this.$initOperationListeners = function () {
            ...
            var t = this.prevOp, n = this.$mergeableCommands,
            ...
            this.$highlightTagPending = !0, setTimeout(function () {
                ...
                var a = r.getCurrentTokenRow(), f = r.getCurrentTokenColumn(),
            ...
            var n = t.start.column - 1, r = t.end.column + 1,
                i = e.getLine(t.start.row), s = i.length,
            ...
            this.clearSelection();
            var f = i.column, l = n.getState(i.row), u = n.getLine(i.row),
                c = r.checkOutdent(l, u, e), h = n.insert(i, e);
            ...
            var t = this.selection.getCursor().row,
                ...
                r = new p(t, n - 1, t, n), i = this.session.getTextRange(r);
            ...
            var n = this.renderer, r = this.renderer.layerConfig,
            ...
            var n = this.getCursorPosition(),
                ...
                i = r.getCurrentToken(), s = i || r.stepForward();
            if (!s) return;
            ...
            var s = this.on("changeSelection", function () {
                ...
                if (r && t && (n.isFocused() || n.searchBox && n.searchBox.isFocused())) {
                    var e = n.renderer, s = e.$cursorLayer.$pixelPos,
                        o = e.layerConfig, u = s.top - o.offset;
    ...
    "use strict";
    var r = e("../lib/dom"), i = e("../lib/oop"), s = e("../lib/lang"),
        o = e("../lib/event_emitter").EventEmitter, u = function (e) {
    ...
    (function () {
        i.implement(this, o), this.setSession = function (e) {
            ...
            var t = this.session, n = e.firstRow,
                i = Math.min(e.lastRow + e.gutterOffset, t.getLength() - 1),
                s = t.getNextFoldLine(n), o = s ? s.start.row : Infinity,
                u = this.$showFoldWidgets && t.foldWidgets, a = t.$breakpoints,
                f = t.$decorations, l = t.$firstLineNumber, c = 0,
    ...
    (function () {
        ...
        this.$padding = 0, this.setPadding = function (e) {
            ...
            var u = this.session, a = n.start.row, f = n.end.row, l = a, c = 0,
                h = 0, p = u.getScreenLastRowColumn(l), d = null,
            ...
            var o = r.lineHeight, u = this.$getTop(t.start.row, r),
                a = this.$padding,
    ...
    "use strict";
    var r = e("../lib/oop"), i = e("../lib/dom"), s = e("../lib/lang"),
        o = e("../lib/useragent"), u = e("../lib/event_emitter").EventEmitter,
        a = function (e) {
    ...
    (function () {
        r.implement(this, u), this.EOF_CHAR = "\u00b6", this.EOL_CHAR_LF = "\u00ac", this.EOL_CHAR_CRLF = "\u00a4", this.EOL_CHAR = this.EOL_CHAR_LF, this.TAB_CHAR = "\u2014", this.SPACE_CHAR = "\u00b7", this.$padding = 0, this.$updateEolChar = function () {
            ...
            var r = Math.max(t, e.firstRow), i = Math.min(n, e.lastRow),
                s = this.element.childNodes, o = 0;
            ...
            var u = r, a = this.session.getNextFoldLine(u),
            ...
            var r = this.element.ownerDocument.createDocumentFragment(), s = t,
            ...
            this.config = e;
            var t = [], n = e.firstRow, r = e.lastRow, i = n,
    ...
    "use strict";
    var r = e("./lib/oop"), i = e("./lib/dom"), s = e("./lib/event"),
        o = e("./lib/event_emitter").EventEmitter, u = 32768, a = function (e) {
    ...
    var r = e("../lib/oop"), i = e("../lib/dom"), s = e("../lib/lang"),
        o = e("../lib/useragent"), u = e("../lib/event_emitter").EventEmitter,
        a = 0, f = t.FontMetrics = function (e) {
    ...
    "use strict";
    var r = e("./lib/oop"), i = e("./lib/dom"), s = e("./config"),
        o = e("./lib/useragent"), u = e("./layer/gutter").Gutter,
        a = e("./layer/marker").Marker, f = e("./layer/text").Text,
        l = e("./layer/cursor").Cursor, c = e("./scrollbar").HScrollBar,
    ...
    (function () {
        this.CHANGE_CURSOR = 1, this.CHANGE_MARKER = 2, this.CHANGE_GUTTER = 4, this.CHANGE_SCROLL = 8, this.CHANGE_LINES = 16, this.CHANGE_TEXT = 32, this.CHANGE_SIZE = 64, this.CHANGE_MARKER_BACK = 128, this.CHANGE_MARKER_FRONT = 256, this.CHANGE_FULL = 512, this.CHANGE_H_SCROLL = 1024, r.implement(this, v), this.updateCharacterSize = function () {
            ...
            var e = this.session, t = this.$size,
                n = t.height <= 2 * this.lineHeight,
                r = this.session.getScreenLength(), i = r * this.lineHeight,
            ...
            var r = this.$cursorLayer.getPixelPosition(e), i = r.left,
                s = r.top, o = n && n.top || 0, u = n && n.bottom || 0,
    ...
    function a(e) {
        var t = u(e), n = window.URL || window.webkitURL,
            r = n.createObjectURL(t);
        return new Worker(r)
    }

    var r = e("../lib/oop"), i = e("../lib/net"),
        s = e("../lib/event_emitter").EventEmitter, o = e("../config"),
    ...
    "use strict";
    var r = e("./range").Range, i = e("./lib/event_emitter").EventEmitter,
        s = e("./lib/oop"), o = function (e, t, n, r, i, s) {
            var o = this;
    ...
    function o(e) {
        var t = e.domEvent, n = t.altKey, o = t.shiftKey, u = t.ctrlKey,
            a = e.getAccelKey(), f = e.getButton();
        ...
        if (f !== 0) return;
        var l = e.editor, c = l.selection, h = l.inMultiSelectMode,
            p = e.getDocumentPosition(), d = c.getCursor(),
            v = e.inSelection() || c.isEmpty() && s(p, d), m = e.x, g = e.y,
            y = function (e) {
                m = e.clientX, g = e.clientY
            }, b = l.session, w = l.renderer.pixelToScreenCoordinates(m, g),
            E = w, S;
    ...
    var r = e("./range_list").RangeList, i = e("./range").Range,
        s = e("./selection").Selection,
        o = e("./mouse/multi_select_handler").onMouseDown, u = e("./lib/event"),
        a = e("./lib/lang"), f = e("./commands/multi_select_commands");
    t.commands = f.defaultCommands.concat(f.multiSelectCommands);
    var l = e("./search").Search, c = new l,
    ...
    (function () {
        ...
        this.ranges = null, this.rangeList = null, this.addRange = function (e, t) {
            ...
            if (this.rangeCount > 1) {
                var e = this.rangeList.ranges, t = e[e.length - 1],
                    n = i.fromPoints(e[0].start, t.end);
                this.toSingleRange(), this.setSelectionRange(n, t.cursor == t.start)
            } else {
                var n = this.getRange(), r = this.isBackwards(),
                    s = n.start.row, o = n.end.row;
                if (s == o) {
                    if (r) var u = n.end, a = n.start; else var u = n.start,
                        a = n.end;
            ...
            if (s) var o = e.column, u = t.column, a = e.offsetX,
                f = t.offsetX; else var o = t.column, u = e.column,
    ...
    (function () {
        this.updateSelectionMarkers = function () {
            ...
            var r = n && n.keepOrder, i = n == 1 || n && n.$byLines,
                o = this.session, u = this.selection, a = u.rangeList,
                f = (r ? u : a).ranges, l;
            ...
            if (!n.length || s.length == n.length - 1) {
                var o = this.selection.getRange(), u = o.start.row,
                    f = o.end.row, l = u == f;
                if (l) {
                ...
                var d = 0, v = Infinity, m = n.map(function (t) {
                    var n = t.cursor, r = e.getLine(n.row),
    ...
    (function () {
        this.getRowLength = function (e) {
            ...
            var r = e.data, i = r.start.row, s = r.end.row,
                o = e.action == "add";
    ...
    "use strict";
    e("./lib/fixoldbrowsers");
    var r = e("./lib/dom"), i = e("./lib/event"), s = e("./editor").Editor,
        o = e("./edit_session").EditSession, u = e("./undomanager").UndoManager,
