...
public class NamespaceBranchController {
	...
	public GrayReleaseRuleDTO findBranchGrayRules(@PathVariable String appId, @PathVariable String clusterName,
	...
	private void checkNamespace(String appId, String clusterName, String namespaceName) {
		...
		if (parentNamespace == null) {
			throw new BadRequestException(
					String.format("Namespace not exist. AppId = %s, ClusterName = %s, NamespaceName = %s", appId,
