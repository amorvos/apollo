...
public class ItemSetControllerTest extends AbstractControllerTest {
	...
	public void testItemSetCreated() {
		...
		ClusterDTO cluster = restTemplate.getForObject(
				"http://localhost:" + port + "/apps/" + app.getAppId() + "/clusters/default", ClusterDTO.class);
		...
		ResponseEntity<Void> response = createdTemplate
				.postForEntity("http://localhost:" + port + "/apps/" + app.getAppId() + "/clusters/" + cluster.getName()
						+ "/namespaces/" + namespace.getNamespaceName() + "/itemset", itemSet, Void.class);
	...
	public void testItemSetUpdated() {
		...
		ResponseEntity<Void> response = createdRestTemplate
				.postForEntity(
		...
		ItemDTO[] items = createdRestTemplate.getForObject("http://localhost:" + port + "/apps/" + app.getAppId()
				+ "/clusters/" + cluster.getName() + "/namespaces/" + namespace.getNamespaceName() + "/items",
				ItemDTO[].class);
	...
	public void testItemSetDeleted() {
		...
		ItemDTO[] items = restTemplate.getForObject("http://localhost:" + port + "/apps/" + app.getAppId()
				+ "/clusters/" + cluster.getName() + "/namespaces/" + namespace.getNamespaceName() + "/items",
				ItemDTO[].class);
