...
public class ReleaseCreationTest extends AbstractIntegrationTest {
	...
	public void testPublishNormalNamespace() {
		...
		Page<ReleaseHistory> releaseHistories = releaseHistoryService.findReleaseHistoriesByNamespace(testApp,
				clusterName, testNamespace, pageable);
	 ...
	 * ---------------------------- k2=v2 | k1=v1 | k1=v1 k3=v3 publish master k2=v2
	...
	public void testPublishMasterNamespaceAndBranchHasNotItems() {
		...
		GrayReleaseRule rule = namespaceBranchService.findBranchGrayRules(testApp, parentClusterName, testNamespace,
				childClusterName);
		...
		Page<ReleaseHistory> releaseHistories = releaseHistoryService.findReleaseHistoriesByNamespace(testApp,
				parentClusterName, testNamespace, pageable);
	...
	/**
	 * Master | Branch ------------------------------ Master | Branch Items k1=v1 |
	 * k1=v1-2 ------------------------- k2=v2 | k1=v1 | k1=v1 k3=v3 publish master
	 * k2=v2 | k2=v2 ------------------------------ ===========>> Result k3=v3 |
	 * k3=v3 Release | | |
	 */
	@Test
	@Sql(scripts = "/sql/release-creation-test.sql", executionPhase = Sql.ExecutionPhase.BEFORE_TEST_METHOD)
	...
	/**
	 * Master | Branch ------------------------------ Master | Branch Items k1=v1 |
	 * k1=v1-2 ---------------------------- k2=v2-2 | publish master k1=v1 | k1=v1-1
	 * ------------------------------ ===========>> Result k2=v2-2 | k2=v2-2 Release
	 * k1=v1 | k1=v1-1 | k2=v2 | k2=v3 k3=v3 | k3=v3
	 */
	@Test
	@Sql(scripts = "/sql/release-creation-test.sql", executionPhase = Sql.ExecutionPhase.BEFORE_TEST_METHOD)
	@Sql(scripts = "/sql/clean.sql", executionPhase = Sql.ExecutionPhase.AFTER_TEST_METHOD)
	...
	/**
	 * Master | Branch ------------------------------ Master | Branch Items k1=v1 |
	 * k1=v1-2 ---------------------------- k2=v2-2 | k4=v4 publish branch k1=v1 |
	 * k1=v1-2 ------------------------------ ===========>> Result k2=v2 | k2=v2
	 * Release k1=v1 | k3=v3 | k3=v3 k2=v2 | | k4=v4 k3=v3 |
	 */
	@Test
	@Sql(scripts = "/sql/release-creation-test.sql", executionPhase = Sql.ExecutionPhase.BEFORE_TEST_METHOD)
	@Sql(scripts = "/sql/clean.sql", executionPhase = Sql.ExecutionPhase.AFTER_TEST_METHOD)
	...
	/**
	 * Master | Branch ------------------------------ Master | Branch Items k1=v1 |
	 * k1=v1-2 ---------------------------- k2=v2-2 | k4=v4 k1=v1 | k1=v1-2 k6=v6
	 * publish branch k2=v2 | k2=v2 ------------------------------ ===========>>
	 * Result k3=v3 | k3=v3 Release k1=v1 | k1=v1-1 | k4=v4 k2=v2 | k2=v2 | k6=v6
	 * k3=v3 | k3=v3 | k4=v4 | k5=v5
	 */
	@Test
	@Sql(scripts = "/sql/release-creation-test.sql", executionPhase = Sql.ExecutionPhase.BEFORE_TEST_METHOD)
	@Sql(scripts = "/sql/clean.sql", executionPhase = Sql.ExecutionPhase.AFTER_TEST_METHOD)
	...
	/**
	 * Master | Branch ------------------------------ Master | Branch Rollback
	 * Release k1=v1 | k1=v1-2 ---------------------------- k2=v2 | k2=v2 k1=v1-1 |
	 * k1=v1-2 | k3=v3 k2=v2-1 | k2=v2-1 rollback k3=v3 | k3=v3
	 * ------------------------------ ===========>> New Release New Release k1=v1-1
	 * | k2=v2-1 | k3=v3 |
	 *
	 *
	 */
	...
	public void testRollback() {
		...
		Release parentNamespaceLatestRelease = releaseService.findLatestActiveRelease(testApp, parentClusterName,
				testNamespace);
		releaseService.rollback(parentNamespaceLatestRelease.getId(), operator);

		Release parentNamespaceNewLatestRelease = releaseService.findLatestActiveRelease(testApp, parentClusterName,
				testNamespace);
		Map<String, String> parentNamespaceConfiguration = parseConfiguration(
		...
		Release childNamespaceNewLatestRelease = releaseService.findLatestActiveRelease(testApp, childClusterName,
				testNamespace);
		Map<String, String> childNamespaceConfiguration = parseConfiguration(
