...
public class InstanceServiceTest extends AbstractIntegrationTest {
	...
	public void testCreateAndFindInstanceConfig() throws Exception {
		...
		InstanceConfig instanceConfig = instanceService.findInstanceConfig(someInstanceId, someConfigAppId,
	...
	public void testFindInstancesByNamespace() throws Exception {
		...
		prepareInstanceConfigForInstance(someInstance.getId(), someConfigAppId, someConfigClusterName,
				someConfigNamespaceName, someReleaseKey, someValidDate);
		prepareInstanceConfigForInstance(anotherInstance.getId(), someConfigAppId, someConfigClusterName,
				someConfigNamespaceName, someReleaseKey, someValidDate);

		Page<Instance> result = instanceService.findInstancesByNamespace(someConfigAppId, someConfigClusterName,
				someConfigNamespaceName, new PageRequest(0, 10));
	...
	public void testFindInstancesByNamespaceAndInstanceAppId() throws Exception {
		...
		Page<Instance> result = instanceService.findInstancesByNamespaceAndInstanceAppId(someAppId, someConfigAppId,
	...
	public void testFindInstanceConfigsByNamespaceWithReleaseKeysNotIn() throws Exception {
		...
		InstanceConfig someInstanceConfig = prepareInstanceConfigForInstance(someInstanceId, someConfigAppId,
				someConfigClusterName, someConfigNamespaceName, someReleaseKey, someValidDate);
		InstanceConfig anotherInstanceConfig = prepareInstanceConfigForInstance(anotherInstanceId, someConfigAppId,
				someConfigClusterName, someConfigNamespaceName, someReleaseKey, someValidDate);
	...
	private InstanceConfig prepareInstanceConfigForInstance(long instanceId, String configAppId,
		...
		InstanceConfig someConfig = assembleInstanceConfig(instanceId, configAppId, configClusterName, configNamespace,
				releaseKey);
	...
	private InstanceConfig assembleInstanceConfig(long instanceId, String configAppId, String configClusterName,
			String configNamespaceName, String releaseKey) {
